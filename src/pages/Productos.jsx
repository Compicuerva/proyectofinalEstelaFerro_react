...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    useEffect(() => {
    document.title = "Moksha Joyas | Productos";
    ...
    // Meta tags básicos
    updateMetaTag('description', 'Explora el catálogo de joyas. Encuentra anillos, dijes, aros, pulseras y collares.');
    updateMetaTag('keywords', 'joyas, anillos, dijes, aros, pulseras, collares');
    updateMetaTag('author', '@webmaster');
    updateMetaTag('robots', 'index, follow');

    // Open Graph
    updateMetaTag('og:title', 'Tienda de Joyas', 'property');
    updateMetaTag('og:description', 'Explora el catálogo de joyas.', 'property');
